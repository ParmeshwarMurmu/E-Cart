    ...
    return (
      <div className="bg-white">
        <div className="pt-6">
          ...
          {/* Product info */}
          <div style={{width: "70%"}} className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                        ...
                        <RadioGroup.Option
                          ...
                          className={({ active }) =>
                            classNames(
                              ...
                              'group relative flex items-center justify-center rounded-md border py-2 text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-2'
                            )
                          }
                        >
                          {({ active, checked }) => (
                              ...
                              {size.inStock ? (
                                ...
                                >
                                  <svg
                                    ...
                                    stroke="currentColor"
                                  >
                                    <line x1={0} y1={10} x2={10} y2={0} vectorEffect="non-scaling-stroke" />
                                  </svg>
                                </span>
                              )}
                            </>
